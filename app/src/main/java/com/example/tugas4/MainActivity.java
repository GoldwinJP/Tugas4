        ...
        switch (view.getId()) {
            case R.id.buttonhp:
                if (phoneNumber.getText().toString() == null || phoneNumber.getText().toString().trim().equals("")) {
                    Toast.makeText(getBaseContext(), "Tolong Masukan No.Handphone Terlebih Dahulu", Toast.LENGTH_LONG).show();
                } else {
            ...
            case R.id.buttonurl:
                if (websiteUri.getText().toString() == null || websiteUri.getText().toString().trim().equals("")) {
                    Toast.makeText(getBaseContext(), "Tolong Masukan URL Terlebih Dahulu", Toast.LENGTH_LONG).show();
                } else {
            ...
            case R.id.buttonlokasi:
                if (locationUri.getText().toString() == null || locationUri.getText().toString().trim().equals("")) {
                    Toast.makeText(getBaseContext(), "Tolong Masukan Lokasi Terlebih Dahulu", Toast.LENGTH_LONG).show();
                } else {
            ...
            case R.id.buttonteks:
                if (textShare.getText().toString() == null || textShare.getText().toString().trim().equals("")) {
                    Toast.makeText(getBaseContext(), "Tolong Masukan Text Terlebih Dahulu", Toast.LENGTH_LONG).show();
                } else {
